...
Proportional Hazards models and AFT models must be interpreted in a different way.  While AFT models give the percentage change in survival time
o	for hazard model, Cox models give the percentage change in the hazard,  following the formula here:
